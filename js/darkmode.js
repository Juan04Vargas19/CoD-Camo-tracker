...
const progresoLight = document.querySelector('.progreso-elemento')
...
if(lightModeEnLS === 'true'){
    ...
    progresoLight.classList.add('progreso-elemento-light')
    progresoLight.classList.remove('progreso-elemento-dark')
...
lightModeBtn.addEventListener('click', () =>{
    ...
    if(lightMode === 'true'){
        ...
        progresoLight.classList.add('progreso-elemento-dark')
        progresoLight.classList.remove('progreso-elemento-light')
